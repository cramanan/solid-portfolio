...
export default function HeroBanner() {
    const { t } = useAppState();
    return (
        <section class="relative mx-auto max-w-screen-xl px-4  sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
            ...
            <div class="flex flex-col-reverse items-center lg:flex-row w-full lg:justify-between">
                <div class="max-w-xl text-center sm:text-left">
                    ...
                    <ul class="mt-4 flex gap-4 justify-center sm:justify-start">
                        <For each={links}>
                            {(item) => (
                                <li>
