...
export default function HeroBanner() {
  ...
  return (
    <section class="lg:p-20 lg:flex lg:items-center h-screen lg:px-20">
      <div class="flex flex-col-reverse justify-center items-center lg:flex-row w-full lg:justify-between h-full">
        <div class="text-center sm:text-left">
          <div class="text-3xl lg:text-7xl font-bold">
            <div class="flex items-center justify-center lg:justify-start gap-2">
              ...
              <img
                ...
                width={64}
                height={64}
                class="w-10 h-10 lg:h-16 lg:w-16 animate-wave select-none"
              />
            </div>
          ...
          <div class="mt-3 flex gap-4 justify-center lg:justify-start">
            ...
            <a href="https://www.linkedin.com/in/cyrilram/" target="_blank">
              <LinkedIn width={50} />
            </a>
          </div>
        </div>
